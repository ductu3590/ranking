-- Correct migration 071's accidental extra VALUES item in the setup-mutation insert.
-- The function body is intentionally replaced forward-only.
BEGIN;
