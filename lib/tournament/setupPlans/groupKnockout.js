...
const { planError, seededShuffle, GROUP_LABELS } = require('./common');
    ...
    stages: [
      {
        ...
        config: { groupCount: combo.groupCount, advancePerGroup: combo.qualifiersPerGroup, poolCount: combo.pool, qualifiersTarget: combo.target, setupPlanVersion: 4 },
      },
      {
