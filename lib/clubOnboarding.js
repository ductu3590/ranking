...
const STEP_KEYS = ['identity', 'roster', 'sepay', 'fund_qr', 'tournament'];
...
function buildSteps(facts) {
    ...
    return [
        ...
        {
            key: 'fund_qr',
            title: 'Phát QR nhận quỹ cho cả nhóm',
            description: 'Tạo QR từ tài khoản quỹ rồi gửi vào nhóm Zalo/Messenger — chỉ tiền vào tài khoản đó mới tự lên sổ.',
            done: hasFundQr,
            state: hasFundQr ? 'done' : 'todo',
            warning: null,
            meta: {},
            // SUA VONG 4: muc "QR nhan quy thanh vien" (#set-qr) da bo — QR gio
            // chi con o khoi Auto Quy (#set-sepay), noi FundQrShare dang mount.
            href: '/admin#set-sepay',
            cta: hasFundQr ? 'Xem lại QR' : 'Tạo & gửi QR',
        },
        {
            key: 'tournament',
