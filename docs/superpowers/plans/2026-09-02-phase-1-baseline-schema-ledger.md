...
- [ ] **Step 1: Write the failing progress consistency test**
...
- [ ] **Step 3: Update both ledgers and register the phase test**
...
- [ ] **Step 4: Run the phase test and confirm GREEN**
...
- [ ] **Step 1: Write failing behavior and boundary tests**
...
- [ ] **Step 3: Implement the pure role filter and session fetch**
...
- [ ] **Step 1: Reproduce the stale CSS failure**
...
- [ ] **Step 2: Remove only obsolete legacy assertions**
...
- [ ] **Step 4: Run the aggregate test command**
...
- [ ] **Step 4: Implement the CLI and protected ledger table**
...
- [ ] **Step 5: Run focused tests and generate the local ledger**
...
- [ ] **Step 1: Write the read-only audit SQL**
...
- [ ] **Step 2: Document the run contract**
...
- [ ] **Step 3: Verify the artifact is read-only**
