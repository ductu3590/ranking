...
function projectSchedule({ courts, runningByCourt, queue, matchMinutes, now }) {
  ...
  if (!activeCourts.length) return { byMatchId: {}, courtByMatchId: {}, finishAt: null };
  ...
  const byMatchId = {};
  // Sân dự kiến (sân trống sớm nhất) — chỉ để hiển thị "Sân 03 · dự kiến 15:05", không gán sân thật.
  const courtByMatchId = {};
  let finishAt = null;
