...
function scheduleToInsertRows(scheduleMatches, { stageId, groupId, divisionId, entryBased = false }) {
  return scheduleMatches.map((m) => ({
    group_id: groupId,
    stage_id: stageId,
    ...(entryBased ? { division_id: divisionId } : {}),
    round: m.round,
    ...
    ...(entryBased ? {
      entry_a_id: m.entrant_a_id != null ? m.entrant_a_id : null,
      entry_b_id: m.entrant_b_id != null ? m.entrant_b_id : null,
    } : {
