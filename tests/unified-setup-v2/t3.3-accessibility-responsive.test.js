...
check('RWD-05 mobile action bar clears global navigation', /\.setup-actionbar\s*\{[\s\S]*bottom:\s*calc\(80px \+ env\(safe-area-inset-bottom\)\)[\s\S]*z-index:\s*1101/.test(shellCss), 'On mobile, the setup action bar must sit above the global bottom navigation and remain tappable.');
