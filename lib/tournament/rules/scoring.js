...
const SCORING_PRESETS = Object.freeze({
  ...
  phong_trao_mac_dinh: Object.freeze({ version: 'phong_trao_mac_dinh', points_to: 11, win_by: 2, cap: 15, best_of: 3, win_points: 1, loss_points: 0, draw_points: 0, deciding_game: null, mlp: null }),
});
...
// D34 (nghiệm thu Epic 2, 2026-09-24): bên nhiều điểm hơn thắng ván. Không kiểm mốc tới / cách / trần —
// giải phong trào đánh 11, 15 hay 21 tùy sân, và thắng cách 2 có thể kéo tới 17–15. `scoring` giữ trong chữ ký
// để nơi gọi không đổi; points_to vẫn dùng cho tỉ số W.O. (096).
