...
// Nhãn kind cho từng vòng, khớp enum tournament_games.kind.
function subKindsFor(rounds) {
  return rounds === 2 ? ['womens', 'mens'] : ['womens', 'mens', 'mixed1', 'mixed2'];
}
