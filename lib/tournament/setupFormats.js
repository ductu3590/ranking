...
const FORMATS = Object.freeze({
  ...
  double_elimination: {
    ...
    enabled: true, // Epic 1 (migration 108 mở cùng thể thức phía SQL)
    supportsFinalBestOf: true, // BO áp cho chung kết tổng (GF), ADR-007 D14
    label: 'Loại kép',
    recommended: [6, 16],
    defaultConfig: { finalBestOf: 1 },
    minPairs() { return 4; },
    maxPairs() { return 32; }, // ADR-007 D15
    validateConfig(config = {}) {
      return validateFinalBestOf(config);
    },
  },
});

const FORMAT_ORDER = Object.freeze(['group_knockout', 'round_robin', 'knockout', 'double_elimination']);
