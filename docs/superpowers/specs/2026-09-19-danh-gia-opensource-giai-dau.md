...
**Kiểm chứng lại:** 24/9/2026 trên `main` tại `e4794e7` (sau các lát A/B/C của
unified setup và Epic 1 loại kép, migration tới 108). Hai kết luận cốt lõi không
đổi: **vẫn chưa có Swiss** và **vẫn chưa có phát hiện xung đột lịch thi đấu**,
nên cả ba đề xuất ở mục 5 còn nguyên giá trị. `lib/tournament` đã tăng lên
**8.493 dòng** — càng nới rộng khoảng cách với 1.447 dòng logic của bracket. Các con số chi tiết bên dưới
