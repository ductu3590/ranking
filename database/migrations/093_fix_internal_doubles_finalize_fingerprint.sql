-- Fix the R3 finalizer fingerprint implementation for projects without pgcrypto.
-- Forward-only: preserve the RPC contract and replace only the request hash implementation.
BEGIN;
